    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('ACTIVE', 'Active'), ('REJECTED', 'Rejected'), ('HIDDEN', 'Hidden'), ('REMOVED', 'Removed')], db_index=True, default='PENDING', max_length=20)),
            ],
            options={
                'ordering': ('-created_at',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(blank=True, help_text='Short summary about company.', max_length=500)),
                ('description', models.CharField(blank=True, help_text='Longer description about company.', max_length=500)),
                ('kind', models.CharField(choices=[('UNKNOWN', 'Unknown'), ('CLINIC', 'Clinic'), ('OTHER', 'Other')], db_index=True, default='UNKNOWN', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('INVITED', 'Invited'), ('PENDING', 'Pending'), ('ACTIVE', 'Active'), ('REJECTED', 'Rejected'), ('HIDDEN', 'Hidden'), ('REMOVED', 'Removed')], default='PENDING', max_length=20)),
