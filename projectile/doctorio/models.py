...
class Doctor(BaseModelWithUID):
    ...
    appointment_fee = models.DecimalField(max_digits=10, null=True, blank=True, decimal_places=2, default=0)
    consultation_fee = models.DecimalField(max_digits=10, null=True, blank=True, decimal_places=2, default=0)
    follow_up_fee = models.DecimalField(max_digits=10, null=True, blank=True, decimal_places=2, default=0)
    check_up_fee = models.DecimalField(max_digits=10, null=True, blank=True, decimal_places=2, default=0)
